...
type InsightsReport struct {
	// downloadedTime is a required time when the last Insights report was downloaded.
	...
	// healthChecks is an optional field that provides basic information about active Insights health checks
	// in a cluster.
	// +listType=map
...
type DataGatherList struct {
	...
	// +listType=atomic
	// +kubebuilder:validation:MaxItems=100
	// +kubebuilder:validation:MinItems=100
	// +optional
