...
func TestClient_RecvGatheringRules(t *testing.T) {
	...
	insightsClient := insightsclient.NewInsightsClient(http.DefaultClient, 0, "", &MockAuthorizer{}, configClient, nil)
...
func TestClient_RecvReport(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			insightsClient := insightsclient.NewInsightsClient(http.DefaultClient, 0, "test", &MockAuthorizer{}, configClient, nil)
...
func TestClient_RecvClusterTransfer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			insightsClient := insightsclient.NewInsightsClient(http.DefaultClient, 0, "test", &MockAuthorizer{token: "test-token"}, configClient, nil)
