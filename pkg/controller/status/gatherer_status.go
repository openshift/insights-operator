...
func DataGatherStatusToOperatorStatus(dg *insightsv1.DataGather) v1.InsightsOperatorStatus {
	...
	// TODO: handle the insightsReport being nil
	if dg.Status.InsightsReport != nil && dg.Status.InsightsReport.DownloadedTime != nil {
		...
		fmt.Println("downloadTime or insightsReport is nil")
	}
	...
	// TODO: check this
	if dg.Status.InsightsReport == nil {
