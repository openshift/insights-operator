...
type ConfigObserverController struct {
	...
	trackedCrds []schema.GroupVersion
...
func (c *ConfigObserverController) AddTrackedCustomResourceDefinition(gv schema.GroupVersion) {
	c.trackedCrds = append(c.trackedCrds, gv)
}
