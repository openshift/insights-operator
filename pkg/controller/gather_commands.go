...
func (g *GatherJob) GatherAndUpload(kubeConfig, protoKubeConfig *rest.Config) error { // nolint: funlen, gocyclo
	...
	dataGatherCR, err = status.UpdateProgressingCondition(ctx, insightsV1Cli, dataGatherCR, status.GatheringReason)
	if err != nil {
...
func updateDataGatherStatus(ctx context.Context, insightsClient insightsv1client.InsightsV1Interface,
	dataGatherCR *insightsv1.DataGather, conditionToUpdate *metav1.Condition, gatheringStatus string,
) {
