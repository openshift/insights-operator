...
func TestWasDataUploaded(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			mockController := NewWithTechPreview(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestUpdateInsightsReportInDataGather(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockController := NewWithTechPreview(nil, mockCMConf, nil, nil, nil, insightsCs.InsightsV1(), nil, nil, nil, nil)
