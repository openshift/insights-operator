...
// TODO: move it somewhere else, consifer creating enum type for TotalRisk
// and implementing the methods for conversion
var reverseTotalRiskMapping = map[int32]insightsv1alpha2.TotalRisk{
	1: insightsv1alpha2.TotalRiskLow,
	2: insightsv1alpha2.TotalRiskModerate,
	3: insightsv1alpha2.TotalRiskImportant,
	4: insightsv1alpha2.TotalRiskCritical,
}
...
func (c *Controller) updateInsightsReportInDataGather(ctx context.Context,
	...
	for _, recommendation := range report.Recommendations {
		...
		healthCheck := insightsv1alpha2.HealthCheck{
			...
			TotalRisk:   reverseTotalRiskMapping[recommendation.TotalRisk],
...
func (c *Controller) createNewDataGatherCR(ctx context.Context) (*insightsv1alpha2.DataGather, error) {
	...
	gatherers, dataPolicy, storageSpec := c.createDataGatherAttributeValues()
	...
	dataGatherCR.Spec.Gatherers = &gatherers
...
func (c *Controller) createDataGatherAttributeValues() (
	...
	gatherer := insightsv1alpha2.Gatherers{
		// Mode can be set only to All and Custom. InsightsDataGather also allows the None option, however the
		// DataGather resource is not created when gathering is disabled.
		Mode: insightsv1alpha2.GatheringMode(gatherConfig.Gatherers.Mode),
	}
