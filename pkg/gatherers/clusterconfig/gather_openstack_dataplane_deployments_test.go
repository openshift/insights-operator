...
`},
			exp: []string{"customresources/dataplane.openstack.org/openstackdataplanedeployments/openstack/test-cr"},
		},
		{
...
`},
			exp: []string{
				"customresources/dataplane.openstack.org/openstackdataplanedeployments/openstack/test-cr-1",
				"customresources/dataplane.openstack.org/openstackdataplanedeployments/openstack/test-cr-2",
			},
		},
	}
