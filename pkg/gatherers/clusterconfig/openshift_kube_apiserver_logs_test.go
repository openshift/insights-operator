...
func Test_GatherOpenShiftKubeAPIServerLogs(t *testing.T) {
	tests := []struct {
		name    string
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			kubeAPIServerCollectLogsFromContainers = func(
				ctx context.Context,
			...
			// Given
			records, err := mockGatherer.GatherOpenShiftKubeAPIServerLogs(context.TODO())
